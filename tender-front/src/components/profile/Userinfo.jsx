      ...
      <div className="userInfo">
        <form className="signUpForm" action="" method="POST">
            ...
            <div className="formSection">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(event) => {
                    setUserOrganizationName(event.target.value);
                  }}
                  disabled={!editableForm}
                ></input>
              </div>
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="role"
                  onChange={(event) => {
                    setUserOrganizationRole(event.target.value);
                  }}
                  disabled={!editableForm}
                ></input>
              </div>
              <div className="form-group">
                <label htmlFor="role">
                  Your nickname or reference within the organization
                </label>
                <input
                  id="role"
                  type="text"
                  ...
                  placeholder="role"
                  onChange={(event) => {
                    setUserOrganizationNick(event.target.value);
                  }}
                  disabled={!editableForm}
                ></input>
              </div>
          ...
          {!editableForm ? (
            ...
            <div>
              <button type="submit" className="btn btn-default btn-centered">
                Submit updated data
              </button>
              <button
                className="btn btn-default btn-centered"
