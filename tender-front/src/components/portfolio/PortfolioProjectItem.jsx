      ...
      <div className="portfolioProjList__item">
        <div className="item__content">
          <div className="item__img">
            <img
              className="img--insideCard"
              alt=""
              src={project.img.replace(" ", "")}
            />
          </div>
          <div className="item__text">
            ...
            <div className="text__subtitle">
              <Link to={`project/${project.slug}`}>
                <button className="card__button">OPEN PROJECT</button>
              </Link>
              <Link to={`project/${project.slug}`}>
                <button className="card__button">TOTAL BUDGET</button>
              </Link>
              <Link to={`project/${project.slug}`}>
                <button className="card__button">TOTAL ACTUAL</button>
              </Link>
            </div>
            ...
            <div className="location__bar">
              ...
              <div className="location__text">
                <p>
                  {project.location.street}, {project.location.city},{" "}
